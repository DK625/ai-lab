...
| Content | Full text |
**Project Description:** An AI coding agent performing multi-step feature planning, codebase discovery, and technical research using the Model Context Protocol (MCP)
...
const results = await exa.search("React hooks best practices 2024", {
  "type": "auto",
  "num_results": 10,
  "contents": {
    "text": {
